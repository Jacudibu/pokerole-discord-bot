...
impl Pokemon {
    pub fn add_pre_evo_moves(&mut self, pre_evo_learns: &LearnablePokemonMoves) {
...
impl Pokemon {
    pub fn build_pokedex_string(&self) -> String {
...
impl Pokemon {
    pub fn get_stat(&self, stat: &Stat) -> &PokemonStat {
        match stat {
...
impl Pokemon {
    pub fn build_all_learnable_moves_list(&self, emoji: String) -> impl Into<String> + Sized {
...
impl PokemonMoveLearnedByRank {
    pub fn new(raw: &RawPokemonMoveLearnedByLevelUp) -> Self {
